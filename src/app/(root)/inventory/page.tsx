...
export default function InventoryPage() {
    ...
    const { selectedItem, setSelectedItem, handleEquip, isEquipped, itemsWithOwnership } = useInventoryLogic(user?.id, character)
        ...
        <div className="min-h-screen p-4">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-amber-200 mb-2" style={{ fontFamily: "serif" }}>
                        Inventory
                    </h1>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-1">
                        ...
                        <div className="mt-4 flex justify-center bg-[#3a2718] rounded-lg p-4 border-2 border-[#5a3a23]">
                            <CharacterPreview
